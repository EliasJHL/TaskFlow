...
export type BoardEventPayload = AssigneeAddedToCardEvent | AssigneeRemovedFromCardEvent | CardCreatedEvent | CardDeletedEvent | CardMovedEvent | LabelAddedToCardEvent | LabelCreatedEvent | LabelDeletedEvent | LabelRemovedFromCardEvent | ListCreatedEvent | ListDeletedEvent | ListMovedEvent;
