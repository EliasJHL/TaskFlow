          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center relative z-10">
            <div className="flex flex-col items-start text-left space-y-8">
              ...
              <div className="max-w-lg text-lg text-muted-foreground sm:text-xl leading-loose">
                ...
                <br />
                <br />
                Conçue pour les développeurs, synchronisée avec GitHub,{' '}
                <Highlighter
                  action="highlight"
            ...
            >
              ...
              >
                ...
                <div>
                  <p className="text-sm font-bold">Tâche terminée</p>
              ...
              >
                ...
                <div>
                  <p className="text-sm font-bold">Tâche en retard</p>
                  <p className="text-xs text-muted-foreground">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold md:text-5xl leading-tight">
                ...
                <span className="text-primary">Bidirectionnelle.</span>
              </h2>
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                Ne perdez plus de temps à copier-coller. Vos Issues GitHub
                deviennent des cartes TaskFlow. Vos Pull Requests déplacent les
              ...
              <Button
                ...
                variant="secondary"
              >
                <GitPullRequest className="mr-2 h-5 w-5" /> Connecter un
                Repository
              </Button>
            </div>
            ...
            >
              <div className="flex size-full flex-col items-stretch justify-between gap-15">
                <div className="flex flex-row items-center justify-between mt-24">
                  ...
                  <Circle ref={taskflowRef} className="bg-primary/10">
                    <img
        ...
        <section className="container py-32 px-4 relative">
          <div className="mb-16 max-w-3xl mx-auto text-center relative z-10">
            ...
            <p className="mt-6 text-muted-foreground text-lg leading-relaxed">
              Fini la dispersion. TaskFlow centralise la gestion de projet tech
              avec une architecture robuste et des fonctionnalités pensées pour
              les devs.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-4xl font-bold md:text-5xl leading-tight mb-6">
                ...
                <span className="text-muted-foreground">en 30 secondes.</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                Vous voulez garder vos données chez vous ? TaskFlow est conçu
                pour être auto-hébergé. Un simple fichier Docker Compose suffit
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold">Clonez le repo</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold">Lancez Docker</h4>
                    <p className="text-sm text-muted-foreground">
                ...
                <Terminal className="min-h-[300px] w-full rounded-xl border border-border bg-black/90 shadow-2xl">
                  <div className="flex flex-col gap-2 p-1 font-mono text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-blue-400">~/taskflow</span>
...
`}
                      ...
                      <div className="flex gap-2">
                        <span className="text-green-500">✔</span> Network
                        taskflow_default created
                      </div>
                      <div className="flex gap-2">
                        <span className="text-green-500">✔</span> Container
                        taskflow-db started
                      </div>
                      <div className="flex gap-2">
                        <span className="text-green-500">✔</span> Container
                        taskflow-redis started
                      </div>
                      <div className="flex gap-2">
                        <span className="text-green-500">✔</span> Container
