        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg font-medium leading-relaxed">
              &ldquo;C'est la première fois que je vois un outil de gestion de
              projet aussi rapide. L'interface est incroyable et la synchro
              GitHub change la vie.&rdquo;
            </p>
            <footer className="text-sm text-zinc-400">
              Sofia Davis, Lead Dev chez Vercel
            </footer>
          </blockquote>
        </div>
      </div>
