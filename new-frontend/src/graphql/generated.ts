...
export type BoardEventPayload = CardCreatedEvent | CardDeletedEvent | CardMovedEvent | LabelCreatedEvent | LabelDeletedEvent | ListCreatedEvent | ListDeletedEvent | ListMovedEvent;
